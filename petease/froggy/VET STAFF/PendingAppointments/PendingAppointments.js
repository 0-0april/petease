// View Pending Appointments JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
            ...
            appointmentItem.innerHTML = `
                ...
                <div class="appointment-details">
                    ...
                    <div class="appointment-actions">
                        <button class="btn btn-primary" onclick="confirmAppointment(${appointment.id})">Confirm</button>
                        <button class="btn btn-danger" onclick="cancelConfirmation(${appointment.id})">Cancel</button>
    ...
    window.cancelConfirmation = function(id) {
    ...
    // Function to close action section
    document.addEventListener('click', function(e) {
        if (e.target.classList.contains('close-btn') || e.target.id === 'cancel-appointment-btn') {
            const actionSection = document.querySelector('.action-section');
