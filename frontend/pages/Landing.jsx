        ...
        <div className="relative max-w-7xl mx-auto flex flex-col items-start py-20"
          ...
          <div className="w-full lg:w-[58%] text-center lg:text-left">
            <span className="inline-block rounded-full px-4 py-1.5 text-xs font-semibold uppercase tracking-widest mb-6"
              style={{
                background:'hsla(130,100%,30%,0.14)',
            ...
            <h1 className="heading-dark text-5xl sm:text-6xl lg:text-7xl mb-6"
              style={{ textShadow: '0 2px 12px rgba(255,255,255,0.55), 0 1px 3px rgba(255,255,255,0.4)' }}>
              Find a Friend.<br />
              <span style={{ color:'hsl(130,100%,30%)', textShadow: '0 2px 12px rgba(255,255,255,0.55)' }}>Care for Life.</span>
            </h1>
            <p className="text-lg mb-10 max-w-xl mx-auto lg:mx-0 font-light"
              style={{ color:'hsla(140,100%,7%,0.58)', lineHeight:'1.75', textShadow: '0 1px 6px rgba(255,255,255,0.5)' }}>
              PetEase connects pet owners, adopters, and veterinary staff in one seamless platform.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link to="/register" className="btn-pay text-center"
                style={{ padding:'14px 36px', boxShadow:'0 4px 24px rgba(0,0,0,0.18), 0 1px 4px rgba(0,0,0,0.10)' }}>
                Start Adopting
              </Link>
              <Link to="/login" className="btn-outline text-center"
                style={{ padding:'13px 36px', boxShadow:'0 4px 16px rgba(0,0,0,0.12)' }}>
                Sign In
              </Link>
            </div>
          </div>
