...
const dashboardCards = [
  ...
  },
  {
    to: '/my-pets',
    label: 'My Pets',
    description: 'Register and manage your pets',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    to: '/appointments',
    label: 'Appointments',
    description: 'Book vet appointments',
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {dashboardCards.map(card => (
            ...
            >
              <div className="flex items-start gap-4">
                <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center ${card.color} transition-transform group-hover:scale-105`}>
                  {card.icon}
                </div>
