        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex min-h-16 items-center justify-between gap-3 py-3">
            <div className="flex min-w-0 items-center gap-4 lg:gap-8">
              <Link to="/vet/dashboard" className="shrink-0 text-xl sm:text-2xl font-bold text-primary tracking-tight">
                PetEase Vet
              </Link>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <Link
                ...
                className="inline-flex h-10 w-10 items-center justify-center rounded-full text-gray-600 hover:text-primary hover:bg-green-50 transition-colors"
                title="Notifications"
              >
