...
import { createNotification, createNotificationsForVets } from '../../_lib/notifications.js';
  ...
  try {
    ...
    if (data.USER?.AccID) {
      await createNotification({
        ...
        message: `Your adoption request for ${petName} was approved.`,
        type: 'adoption',
      });
    }
    ...
    await createNotificationsForVets({
      ...
      message: `An adoption for ${petName} has been approved and is ready for vet waiver processing.`,
      type: 'adoption',
    });
