  ...
  try {
    ...
    res.json({
      adoptions: (data || []).map(a => ({
        id: a.AdoptID,
        petId: a.USERPETS.PET.PetID, petName: a.USERPETS.PET.PetName,
        petBreed: a.USERPETS.PET.PetBreed, petImage: a.USERPETS.PET.PetImg,
        adopterName: a.USER.UserName, adopterEmail: a.USER.ACCOUNT.AccEmail,
        adopterPhone: a.USER.ACCOUNT.AccPhoneNum || 'N/A',
        status: a.AdoptStatus.toLowerCase(), createdAt: a.AdoptReqDate,
        waiverDocument: a.AdoptionWaiver, message: '',
